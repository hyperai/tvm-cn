...
我们预设每个人在参与该项目时都戴着他们的Apache committer帽子，即：在项目活动中，committer应该为了项目的最佳利益而行动。在任何方面，注意区分你在committer和其他可能担任身份中的角色都非常重要。

在参与项目时，明确表示你在以何种身份或角色行动，来防止你的言行产生一些误会或者困惑，特别是在你没有戴着committer帽子的情况下。以下是两个示例：

- "戴着[foo]帽子：[作为担任foo角色而不是committer发表观点]"。
- "戴着Apache TVM帽子：[作为committer发表观点]"。
