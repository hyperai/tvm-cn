...
* **参数：**
   * **mod** ([tvm.ir.module.IRModule](/docs/api-reference/python-api/tvm-ir#class-tvmirirmodulefunctionsnone-attrsnone-global_infosnone))  – 正在运行优化过程的模块。
   * **info** ([tvm.transform.PassInfo](/docs/api-reference/python-api/tvm-transform#class-tvmtransformpassinfoopt_level-name-requirednone-traceablefalse))  –  Pass 信息。
...
* **参数：**
  * **mod** ([tvm.ir.module.IRModule](/docs/api-reference/python-api/tvm-ir#class-tvmirirmodulefunctionsnone-attrsnone-global_infosnone))  – 正在运行优化过程的模块。
   * **info** ([tvm.transform.PassInfo](/docs/api-reference/python-api/tvm-transform#class-tvmtransformpassinfoopt_level-name-requirednone-traceablefalse))  – Pass信息。
* **返回类型：** 无。
